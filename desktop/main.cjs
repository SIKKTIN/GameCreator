...
if (!app.requestSingleInstanceLock()) app.quit();
  ...
  for(const operation of ['preview','apply','history','recover','release','binding','rebind','feedbackScan','feedbackApply','feedbackApplyBatch','feedbackRepair','dataSchemaExport','dataPublish','dataPreview','dataApply','dataRecover','dataUndo','dataRelease'])ipcMain.handle('engine-sync-'+operation,(event,input)=>{
