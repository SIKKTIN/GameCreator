...
async function validateExample(expected) {
  ...
  assert.deepEqual(Object.keys(example).filter(k=>k !== 'storyOrchestration' && k !== 'mapDesign' && k !== 'projectSchedule' && k !== 'numericalAnalysis' && k !== 'developmentTools').sort(), ['schema', 'name', 'description', 'gameplay', 'gameplayCore', 'prototypeDesign', 'taskFlows', 'functionalSystems', 'artAssets', 'data', 'definitions', 'stories'].sort(), 'example contains missing or nonportable top-level fields');
