...
async function validateExample(expected) {
  ...
  assert.deepEqual(Object.keys(example).filter(k=>k !== 'storyOrchestration').sort(), ['schema', 'name', 'description', 'gameplay', 'gameplayCore', 'taskFlows', 'functionalSystems', 'artAssets', 'data', 'definitions', 'stories'].sort(), 'example contains missing or nonportable top-level fields');
