...
test('project package IPC accepts only native-selected folders and window-owned opaque import tokens', async () => {
  ...
  for (const channel of ['project-package-export', 'project-package-choose-import', 'project-package-restore-assets', 'project-package-release', 'ai-credential-issue', 'ai-developer', 'project-authoring']) {
