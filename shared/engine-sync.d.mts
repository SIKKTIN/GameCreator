...
export function syncDocuments(document:import('../src/ai-export').AiDocument,modules:string[],context?:{projectId?:string;projectDirectory?:string;engineDirectory?:string;docsDirectory?:string;collaboration?:boolean}):SyncDocument[];
