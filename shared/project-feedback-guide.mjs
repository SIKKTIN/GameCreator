export function projectFeedbackGuide(project){
 const common={schema:1,projectId:project.projectId,engine:project.engine,id:'00000000-0000-4000-8000-000000000002',snapshotId:project.snapshotId,author:'开发者名称',summary:'说明修改事项',evidence:['依据与验证结果'],reason:'为什么需要修改',impact:'对实现、测试和计划的影响'};
