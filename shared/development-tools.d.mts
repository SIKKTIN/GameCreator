...
export type DevelopmentTool = { id:string; name:string; kind:typeof developmentToolKinds[number]; status:typeof developmentToolStatuses[number]; priority:typeof developmentToolPriorities[number]; owner:string; audience:string; purpose:string; scope:string; inputs:string; outputs:string; environment:string; acceptance:string; usage:string; delivery:string; capabilityIds:string[]; archived:boolean };
export type DevelopmentToolsStore = { schema:1; tools:DevelopmentTool[] };
