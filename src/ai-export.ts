...
export function buildAiMarkdown(project: ExportProject, stories: ExportStory[], data: ProjectData, definitions: DatasetDef[], config: EngineConfig, registry: EnumRegistry, gameplay: GameplayDesign[] = []) {
  ...
  lines.push(gameplayMarkdown(gameplay, { stories, datasets: definitions }), '');
  lines.push('## 故事文档', '');
