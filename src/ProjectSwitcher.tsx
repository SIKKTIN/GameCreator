...
export function ProjectSwitcher({ projects, currentId, currentName, testName, canAdd, busy, onSelect, onAdd, onConnectTeam, onImportPrototype, onImportProject, onExportProject }: ProjectSwitcherProps) {
