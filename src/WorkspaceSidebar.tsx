...
export function WorkspaceSidebar({ picker, active, onNavigate, team = false, teamOverview = false, admin = false, onManageServer, footer }: {
  picker: ReactNode; active: string; onNavigate: (name: string) => void; team?: boolean; teamOverview?: boolean; admin?: boolean; onManageServer?: () => void; footer: ReactNode;
}) {
