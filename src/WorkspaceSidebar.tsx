...
import { Map, Layers, Gamepad2, ListTree, Palette, BookOpen, Database, Tag, Settings2, GitBranch, BarChart3, Server, Workflow, Users, PanelsTopLeft } from 'lucide-react';

export const workspaceNavigation = [
  ['项目概览', Layers], ['玩法核心', Workflow], ['玩法设计', Gamepad2], ['原型设计', PanelsTopLeft], ['地图设计', Map], ['功能系统', ListTree], ['美术资产', Palette], ['故事文档', BookOpen], ['故事编排', BookOpen],
  ['数据配置', Database], ['枚举定义', Tag], ['枚举管理', Tag], ['引擎设置', Settings2], ['任务与流程', GitBranch], ['数值分析', BarChart3],
] as const;

export function WorkspaceSidebar({ picker, active, onNavigate, team = false, empty = false, teamOverview = false, teamCore = false, admin = false, onManageServer, onManageUsers, storyEnabled = false, mapEnabled = false, footer }: {
  mapEnabled?: boolean; storyEnabled?: boolean; picker: ReactNode; active: string; onNavigate: (name: string) => void; team?: boolean; empty?: boolean; teamOverview?: boolean; teamCore?: boolean; admin?: boolean; onManageServer?: () => void; onManageUsers?: () => void; footer: ReactNode;
}) {
