  ...
  return (
    <div className="app local-workspace">
      ...
      <main hidden={!!serverPage} className={active === '玩法核心' ? 'core-workspace-page' : undefined}>
        ...
        {active === '故事编排' && narrative.store.enabled && <StoryOrchestration controller={narrative} data={currentData} tasks={tasks.store.tasks} selectedId={narrativeId} onSelect={setNarrativeId} onOpenTask={id=>{setRequestedTask({id});setActive('任务与流程');}}/>}
