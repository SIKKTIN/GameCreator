...
import type {DataDifference,DataSyncHistory,Decision,JsonFormat} from '../shared/data-sync.mjs';
export type DataSyncFile={table:string;file:string;error?:string;mapping?:Record<string,string>;shape?:JsonFormat['shape'];differences?:DataDifference[];bound?:boolean;localChanged?:boolean;engineChanged?:boolean;fields?:{local:string[];remote:string[]}};
