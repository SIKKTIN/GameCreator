...
export type FeedbackScan={contentReload?:boolean;root:string;entries:FeedbackEntry[];history:FeedbackReceipt[];missingReceipts:string[]};
...
export type EngineSyncAPI=import('./data-sync').DataSyncAPI&{
  ...
  feedbackApply:(input:{token:string;decisions:Record<string,'keep'|'feedback'>;dismiss:boolean;acceptCompletion:boolean;acceptLegacy?:boolean;acceptProjectChange?:boolean})=>Promise<FeedbackApplyResult>;
