...
export type EngineSyncAPI={
  ...
  feedbackApply:(input:{token:string;decisions:Record<string,'keep'|'feedback'>;dismiss:boolean;acceptCompletion:boolean})=>Promise<{receipt:FeedbackReceipt;warning:string}>;
